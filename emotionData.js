// Plutchik's Wheel of Emotions Data with Intensity Levels
// Each emotion has three intensity levels: mild (inner), medium (middle), strong (outer)
export const EMOTIONS = {
    joy: { 
        ...
        label: 'joy',
        intensities: {
            mild: { level: 1, label: 'serenity', color: '#FFF9E6' },
            medium: { level: 2, label: 'joy', color: '#FFD700' },
            strong: { level: 3, label: 'ecstasy', color: '#FFA000' }
        }
    },
    trust: { 
        color: '#00C853', 
        ...
        label: 'trust',
        intensities: {
            mild: { level: 1, label: 'acceptance', color: '#C8E6C9' },
            medium: { level: 2, label: 'trust', color: '#00C853' },
            strong: { level: 3, label: 'admiration', color: '#00701A' }
        }
    },
    fear: { 
        color: '#1B5E20', 
        ...
        label: 'fear',
        intensities: {
            mild: { level: 1, label: 'apprehension', color: '#C5E1A5' },
            medium: { level: 2, label: 'fear', color: '#1B5E20' },
            strong: { level: 3, label: 'terror', color: '#0D2F10' }
        }
    },
    surprise: { 
        color: '#2196F3', 
        ...
        label: 'surprise',
        intensities: {
            mild: { level: 1, label: 'distraction', color: '#BBDEFB' },
            medium: { level: 2, label: 'surprise', color: '#2196F3' },
            strong: { level: 3, label: 'amazement', color: '#0D47A1' }
        }
    },
    sadness: { 
        color: '#0D47A1', 
        ...
        label: 'sadness',
        intensities: {
            mild: { level: 1, label: 'pensiveness', color: '#BBDEFB' },
            medium: { level: 2, label: 'sadness', color: '#0D47A1' },
            strong: { level: 3, label: 'grief', color: '#051E42' }
        }
    },
    disgust: { 
        color: '#9C27B0', 
        ...
        label: 'disgust',
        intensities: {
            mild: { level: 1, label: 'boredom', color: '#E1BEE7' },
            medium: { level: 2, label: 'disgust', color: '#9C27B0' },
            strong: { level: 3, label: 'loathing', color: '#4A148C' }
        }
    },
    anger: { 
        color: '#D32F2F', 
        ...
        label: 'anger',
        intensities: {
            mild: { level: 1, label: 'annoyance', color: '#FFCDD2' },
            medium: { level: 2, label: 'anger', color: '#D32F2F' },
            strong: { level: 3, label: 'rage', color: '#7F0000' }
        }
    },
    anticipation: { 
        color: '#FF6F00', 
        ...
        label: 'anticipation',
        intensities: {
            mild: { level: 1, label: 'interest', color: '#FFE0B2' },
            medium: { level: 2, label: 'anticipation', color: '#FF6F00' },
            strong: { level: 3, label: 'vigilance', color: '#BF360C' }
        }
    }
};
